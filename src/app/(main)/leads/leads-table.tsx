...
export function LeadsTable({ initialLeads, leadLists: initialLeadLists }: LeadsTableProps) {
  ...
  return (
    <>
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 min-w-0 overflow-hidden">
        <Table className="table-fixed w-full">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[7%]">City</TableHead>
              ...
              <TableHead className="w-[8%]">List</TableHead>
              ...
              leads.map((lead) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="font-medium min-w-0 max-w-0" title={lead.name}>
                      <span className="block truncate">{lead.name}</span>
                    </TableCell>
                    <TableCell className="min-w-0 truncate">{lead.city || '—'}</TableCell>
                    <TableCell className="min-w-0 truncate">{lead.phone}</TableCell>
                    <TableCell className="min-w-0 max-w-0" title={lead.email || undefined}>
                    ...
                    <TableCell className="min-w-0 truncate">{lead.list?.name || '—'}</TableCell>
                    <TableCell>
                      <span
