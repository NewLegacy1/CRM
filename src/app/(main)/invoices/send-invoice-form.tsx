...
interface SendInvoiceFormProps {
  ...
  onSuccess: (invoice: { id: string; client_id: string; status: string; currency: string; amount_total: number; due_date: string | null; created_at: string; stripe_invoice_id: string | null; client?: { id: string; name: string; email: string | null } }) => void
  onCancel: () => void
}

export function SendInvoiceForm({ clients, onSuccess, onCancel }: SendInvoiceFormProps) {
