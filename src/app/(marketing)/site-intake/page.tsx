...
import { SiteIntakeWizard } from "@/components/marketing/intake/SiteIntakeWizard";
      ...
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <header className="mb-10">
          <h1 className="font-heading text-3xl font-bold tracking-tight text-[#FAFAFA] sm:text-4xl">
            Website <span className="gradient-text-highlight">intake</span>
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-white/70 md:text-base">
            A few short steps so we understand your business, scope, and constraints. You can move back anytime. We&apos;ll
            follow up by email.
          </p>
        </header>
        ...
        {status === "ok" ? (
          ...
          <SiteIntakeWizard onSuccess={() => setStatus("ok")} />
        )}
      </div>
