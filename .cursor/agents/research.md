...
4. Write output to the file path provided in your prompt (or return the structured report in your final message if no file path is given)
...
## Conventions (from prior agent — keep when useful)

- **Actionable:** The parent should be able to act without redoing your research.
- **Conflicts:** If sources disagree, state both sides with citations.
- **Uncertainty:** Say explicitly when the answer is unclear and what would be needed to verify.
- **Prescriptive tone:** Keep “you should do X” style recommendations to one sentence unless the task asked for a longer plan.
